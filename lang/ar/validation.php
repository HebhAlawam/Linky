...
return [
    ...
    'custom' => [
        'logo' => [
            'image' => 'صيغة الشعار غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP, SVG.',
            'mimes' => 'صيغة الشعار غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP, SVG.',
            'mimetypes' => 'صيغة الشعار غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP, SVG.',
            'max' => 'حجم الشعار كبير جدًا. الحد الأقصى المسموح هو 2MB.',
        ],
        'image' => [
            'image' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimetypes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'max' => 'حجم الصورة كبير جدًا. الحد الأقصى المسموح هو 5MB.',
        ],
        'hero_image_1' => [
            'image' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimetypes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'max' => 'حجم صورة الواجهة الأولى كبير جدًا. الحد الأقصى المسموح هو 8MB.',
        ],
        'hero_image_2' => [
            'image' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimetypes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'max' => 'حجم صورة الواجهة الثانية كبير جدًا. الحد الأقصى المسموح هو 8MB.',
        ],
        'hero_image_3' => [
            'image' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'mimetypes' => 'صيغة الصورة غير مدعومة. الصيغ المدعومة هي: JPG, PNG, WEBP.',
            'max' => 'حجم صورة الواجهة الثالثة كبير جدًا. الحد الأقصى المسموح هو 8MB.',
        ],
    ],
