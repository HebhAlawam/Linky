...
body[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; }
  ...
  <meta name="csrf-token" content="AhfHD2irDAqKtCthFu1tWtXd02xJKdhlFx14FFwN">
  <link rel="icon" href="https://mocafecoffee.com/storage/settings/4f87bad9.png">

  <meta name="Developer" content="يم منيو">

  <meta name="theme-color" content="#09b0a2">
  <meta name="msapplication-navbutton-color" content="#09b0a2">
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="facebook-domain-verification" content="">

  <!-- style -->
  <!-- <link rel="stylesheet" type="text/css" media="all" href="https://mocafecoffee.com/assets/css/app.css?id=874f53f01ed1cd0910bc05940dccb840"> -->
     <link rel="stylesheet" type="text/css" media="all" href="{{ asset('ar/style.css')}}">
    ...
    <!-- <link rel="stylesheet" type="text/css" media="all" href="https://mocafecoffee.com/assets/css/app_ar.css?id=22c933e3002edc8172e8ca45c26c2ef1"> -->
     <link rel="stylesheet" type="text/css" media="all" href="{{ asset('ar/stylear.css')}}">

      <meta name="description" content="تبحث عن أفضل قهوة مميزة في مدينة التل – سوريا؟ موكّافي يقدّم مشروبات قهوة ساخنة وباردة بجودة عالية ونكهات غنية، مُحضّرة باحتراف. اطلب بسهولة واستمتع بتجربة قهوة تستحقها. - MOCAFE' موكّافي -  الرئيسية">
    <meta name="keywords" content=", MOCAFE' موكّافي,الرئيسية">
    <title>MOCAFE' موكّافي - الرئيسية</title>
    <!-- Facebook og -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://mocafecoffee.com/ar">
    <meta property="og:title" content="MOCAFE' موكّافي">
        <meta property="og:image" content="https://mocafecoffee.com/storage/settings/68b7f7a9.png">
    <meta property="og:description" content="تبحث عن أفضل قهوة مميزة في مدينة التل – سوريا؟ موكّافي يقدّم مشروبات قهوة ساخنة وباردة بجودة عالية ونكهات غنية، مُحضّرة باحتراف. اطلب بسهولة واستمتع بتجربة قهوة تستحقها.">
    <!-- !Facebook og -->
  ...
  <script>
    window.config = {
      language : 'ar',
      defaultImage : 'https://mocafecoffee.com/assets/img/no-image.png',
      currency : 'ل.س',
      hide_price: '0',
    }
  </script>
<body class="index" id="content" data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    ...
    <div class="header-section sticky">
        <div class="bottom">
            <div class="container">
                <div class="row">
                    <div class="logo">
                        <a href="/"><img src="https://mocafecoffee.com/storage/settings/ed471962.png" alt=""></a>
                    </div>
                    <div class="navbar">
      ...
      <div class="container">
          <div class="owl-carousel owl-theme main-slider owl-loaded" id="slider">


                      <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2592px, 0px, 0px); transition: all; width: 7776px;"><div class="owl-item cloned" style="width: 1296px;"><div class="item">
                <a href="#!">
                  <div class="image">
                    <img src="https://mocafecoffee.com/storage/sliders/6dc5dbfc.jpg">
                  </div>
                </a>
              </div></div><div class="owl-item cloned" style="width: 1296px;"><div class="item">
                <a href="#!">
                  <div class="image">
                    <img src="https://mocafecoffee.com/storage/sliders/ebe62f7c.jpg">
                  </div>
                </a>
              </div></div><div class="owl-item active" style="width: 1296px;"><div class="item">
                <a href="#!">
                  <div class="image">
                    <img src="https://mocafecoffee.com/storage/sliders/6dc5dbfc.jpg">
                  </div>
                </a>
              </div></div><div class="owl-item" style="width: 1296px;"><div class="item">
                <a href="#!">
                  <div class="image">
                    <img src="https://mocafecoffee.com/storage/sliders/ebe62f7c.jpg">
                  </div>
      ...
      <div class="container">
        <div class="categories-storey">
          <div class="main-title ">
            <h3 class="">التصنيفات
              <span class="float-end arrow"><i class="fa-solid fa-angles-left"></i><i class="fa-solid fa-angles-right"></i></span>
            </h3>
          </div>
          <div class="row cat-list">
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    active">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/6" title="قهوة" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/c47bd44f.png" alt="قهوة">
                        </div>
                                            <div class="title"><h3>قهوة</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/24" title="أصناف مميزة" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/b0812b46.png" alt="أصناف مميزة">
                        </div>
                                            <div class="title"><h3>أصناف مميزة</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/7" title="بدون قهوة" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/e43d2fdc.png" alt="بدون قهوة">
                        </div>
                                            <div class="title"><h3>بدون قهوة</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/4" title="موهيتو و صودا" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/374ba989.png" alt="موهيتو و صودا">
                        </div>
                                            <div class="title"><h3>موهيتو و صودا</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/9" title="شيك. فراب. كوكتيل" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/7653e22c.png" alt="شيك. فراب. كوكتيل">
                        </div>
                                            <div class="title"><h3>شيك. فراب. كوكتيل</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/10" title="ميكس عصائر" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/0988ce3b.png" alt="ميكس عصائر">
                        </div>
                                            <div class="title"><h3>ميكس عصائر</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/11" title="حلا" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/c03cfc93.png" alt="حلا">
                        </div>
                                            <div class="title"><h3>حلا</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/12" title="مزيج فواكه" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/60045464.png" alt="مزيج فواكه">
                        </div>
                                            <div class="title"><h3>مزيج فواكه</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/13" title="فطور" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/befe911e.png" alt="فطور">
                        </div>
                                            <div class="title"><h3>فطور</h3></div>
                    </a>
                </div>
              </div>
                          <div class="item col-md-3 col-xl-2 col-sm-4 col-4
                    ">
                <div class="content">
                    <a href="https://mocafecoffee.com/ar/c/14" title="باللتر" data-pjax-state="">
                                              <div class="img">
                          <img src="https://mocafecoffee.com/storage/categories/5571e40f.png" alt="باللتر">
                        </div>
                                            <div class="title"><h3>باللتر</h3></div>
                    </a>
                </div>
              </div>
                      </div>
  ...
  <section class="best-products" id="product">
    <div class="container">
              <div class="main-title"><h3>المنتجات</h3></div>
        <div class="boxes">
          <div class="row">
                          <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 item">
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="كابتشينو">
                        <img src="
                          https://mocafecoffee.com/storage/products/a0678c64.jpg" alt="كابتشينو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                                  <li class="hide" data-id="11"><img src="https://mocafecoffee.com/storage/additions/2aa151da.png"></li>
                                              </ul>
                    </div>
                    </div>
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="كابتشينو">كابتشينو</a>
                    </div>
                                          <p>اسبريسو قوي مميز بنكهة فريدة، مع الحليب بفوم عالي.</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="4" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                              كراميل 15 غ</a></li>
                                                      <li data-id="5" data-price="10000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              10000 ل.س
                              كراميل 25غ</a></li>
                                                      <li data-id="6" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                              سولتد كراميل 15غ</a></li>
                                                      <li data-id="7" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                              موكا 15غ</a></li>
                                                      <li data-id="10" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                              سبانيش</a></li>
                                                      <li data-id="11" data-price="0"><a href="#!"><i class="fa-solid fa-plus"></i>

                              سكر</a></li>
                                                      <li data-id="15" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                              بستاشيو</a></li>
                                                  </ul>
                      </div>
                          ...
                          <h3 data-price="25000" data-currency="ل.س">
                            25000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="ماكياتو اسبريسو">
                        <img src="
                          https://mocafecoffee.com/storage/products/d6676698.jpg" alt="ماكياتو اسبريسو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                                  <li class="hide" data-id="11"><img src="https://mocafecoffee.com/storage/additions/2aa151da.png"></li>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="ماكياتو اسبريسو">ماكياتو اسبريسو</a>
                    </div>
                                          <p>اسبريسو مع فوم الحليب، يمكنك إضافة نكهات.</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="10" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                          ...
                          <h3 data-price="15000" data-currency="ل.س">
                            15000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="ماكياتو لاتيه كلاسيك">
                        <img src="
                          https://mocafecoffee.com/storage/products/d4b9bb08.jpg" alt="ماكياتو لاتيه كلاسيك">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="ماكياتو لاتيه كلاسيك">ماكياتو لاتيه كلاسيك</a>
                    </div>
                                          <p>اسبريسو بنكهة قوية مع كمية قليلة من الحليب المبخر وفوم الحليب.</p>
                                                                                  <div class="q-sec">
                                                <div class="price">
                ...
                <div class="content">
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="أفوغاتو">أفوغاتو</a>
                    </div>
                                          <p>كرة من آيس كريم الفانيليا، المغمورة بجرعة (شوت) من قهوة الإسبريسو الساخنة.</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="4" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                              كراميل 15 غ</a></li>
                                                      <li data-id="9" data-price="6000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              6000 ل.س
                              حليب مكثف محلى</a></li>
                                                      <li data-id="14" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              5000 ل.س
                              شوكولا</a></li>
                                                      <li data-id="15" data-price="8000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              8000 ل.س
                          ...
                          <h3 data-price="23000" data-currency="ل.س">
                            23000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="قهوة فرنسية">
                        <img src="
                          https://mocafecoffee.com/storage/products/6a322396.jpg" alt="قهوة فرنسية">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="قهوة فرنسية">قهوة فرنسية</a>
                    </div>
                                          <p>قهوة بالحليب والكاكاو، يمكنك اختيار اضافات.</p>
                                                                                  <div class="q-sec">
                                                <div class="price">
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="قهوة تركية">
                        <img src="
                          https://mocafecoffee.com/storage/products/f48ddbf0.png" alt="قهوة تركية">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                                  <li class="hide" data-id="11"><img src="https://mocafecoffee.com/storage/additions/2aa151da.png"></li>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="قهوة تركية">قهوة تركية</a>
                    </div>
                                          <p>قهوة تركية محضرة أوتوماتيك</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="11" data-price="0"><a href="#!"><i class="fa-solid fa-plus"></i>
                          ...
                          <h3 data-price="10000" data-currency="ل.س">
                            10000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                      ...
                      <a href="#!" title="V60">
                        <img src="
                          https://mocafecoffee.com/storage/products/ed6ac1cb.jpg" alt="V60">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="V60">V60</a>
                    </div>
                                          <p>قهوة مفلترة بطريقة v60 محضر بالطريقة الخاصة بموكّافي.<br>
يمكنك اختيار نوع حبوب القهوة المستخدمة.</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="19" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              5000 ل.س
                              حبوب قهوة كولومبية</a></li>
                                                      <li data-id="20" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              5000 ل.س
                              حبوب قهوة أثيوبية</a></li>
                                                      <li data-id="21" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              5000 ل.س
                              حبوب قهوة سلفادور</a></li>
                                                      <li data-id="22" data-price="2000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              2000 ل.س
                              مزيج حبوب قهوة موكّافي</a></li>
                                                  </ul>
                      </div>
                                                              <div class="q-sec">
                                                <div class="price">

                          <h3 data-price="35000" data-currency="ل.س">
                            35000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="موكّافي اكسترا لونغ">
                        <img src="
                          https://mocafecoffee.com/storage/products/9b3965f3.png" alt="موكّافي اكسترا لونغ">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="موكّافي اكسترا لونغ">موكّافي اكسترا لونغ</a>
                    </div>
                                          <p>360 مل من القهوة المستخلصة بمثالية عالية<br>
أفضل طعم قهوة يمكنك تجربته<br>
نكهة قوية مليئة بعبق البن الطازج وإيحاءات المكسرات والفواكه<br>
مستخلصة بطريقة مثالية تساعدك على تكرارها دائما بنفس الدقة والطعم.</p>
                                                                                  <div class="q-sec">
                                                <div class="price">
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="اسبريسو">
                        <img src="
                          https://mocafecoffee.com/storage/products/56917d2b.jpg" alt="اسبريسو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                                  <li class="hide" data-id="11"><img src="https://mocafecoffee.com/storage/additions/2aa151da.png"></li>
                                                  <li class="hide" data-id="13"><img src="https://mocafecoffee.com/storage/additions/dc35afcb.png"></li>
                                              </ul>
                    </div>
                    </div>
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="اسبريسو">اسبريسو</a>
                    </div>
                                          <p>مزيج من حبوب الأرابيكا والروبوستا</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="8" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              5000 ل.س
                              كريمة مخفوقة</a></li>
                                                      <li data-id="11" data-price="0"><a href="#!"><i class="fa-solid fa-plus"></i>

                              سكر</a></li>
                                                      <li data-id="13" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              5000 ل.س
                              حليب 50 مل</a></li>
                                                  </ul>
                      </div>
                          ...
                          <h3 data-price="12000" data-currency="ل.س">
                            12000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="شيكراتو">
                        <img src="
                          https://mocafecoffee.com/storage/products/0d5bce7c.jpg" alt="شيكراتو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="شيكراتو">شيكراتو</a>
                    </div>
                                          <p>دبل اسبريسو ممدد بمياه على طريقة استخلاص موكّافي بفوم عالي تجعل نكهة الزيوت وحبوب القهوة المختصة أكثر ظهورا ولذة..<br>
بارد فقط..<br>
</p>
                                                                                  <div class="q-sec">
                                                <div class="price">

                          <h3 data-price="30000" data-currency="ل.س">
                            30000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="موكّافي لونغو">
                        <img src="
                          https://mocafecoffee.com/storage/products/441e42be.jpeg" alt="موكّافي لونغو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="موكّافي لونغو">موكّافي لونغو</a>
                    </div>
                                          <p>أفضل طعم قهوة يمكنك تجربته<br>
نكهة قوية مليئة بعبق البن الطازج وإيحاءات المكسرات والفواكه<br>
مستخلصة بطريقة مثالية تساعدك على تكرارها دائما بنفس الدقة والطعم.</p>
                                                                                  <div class="q-sec">
                                                <div class="price">

                          <h3 data-price="20000" data-currency="ل.س">
                            20000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                      ...
                      <a href="#!" title="دوبيو">
                        <img src="
                          https://mocafecoffee.com/storage/products/23364801.jpg" alt="دوبيو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                                  <li class="hide" data-id="11"><img src="https://mocafecoffee.com/storage/additions/2aa151da.png"></li>
                                                  <li class="hide" data-id="12"><img src="https://mocafecoffee.com/storage/additions/c3d0fc1c.png"></li>
                                                  <li class="hide" data-id="13"><img src="https://mocafecoffee.com/storage/additions/dc35afcb.png"></li>
                                              </ul>
                    </div>
                    </div>
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="دوبيو">دوبيو</a>
                    </div>
                                          <p>كمية مضاعفة من الاسبريسو</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="8" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                              ...
                              سكر</a></li>
                                                      <li data-id="12" data-price="0"><a href="#!"><i class="fa-solid fa-plus"></i>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="أمريكانو">
                        <img src="
                          https://mocafecoffee.com/storage/products/776378f8.jpg" alt="أمريكانو">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="أمريكانو">أمريكانو</a>
                    </div>
                                          <p>دبل اسبريسو ممدد بمياه بطريقة موكّافي.<br>
يمكنك اختيار نوع حبوب القهوة.</p>
                                                                                  <div class="q-sec">
                                                <div class="price">
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="كون بانا">
                        <img src="
                          https://mocafecoffee.com/storage/products/31d78a45.jpg" alt="كون بانا">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                                  <li class="hide" data-id="11"><img src="https://mocafecoffee.com/storage/additions/2aa151da.png"></li>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="كون بانا">كون بانا</a>
                    </div>
                                          <p>اسبريسو مع كريمة مخفوقة</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
                                                      <li data-id="8" data-price="5000"><a href="#!"><i class="fa-solid fa-plus"></i>
                          ...
                          <h3 data-price="18000" data-currency="ل.س">
                            18000 ل.س
                          </h3>
                        </div>
                      </div>
                ...
                <div class="content">
                                      <div class="image">
                      <a href="#!" title="آيس دريب">
                        <img src="
                          https://mocafecoffee.com/storage/products/58f25e86.jpg" alt="آيس دريب">
                      </a>
                    <div class="addetion-image">
                      <ul>
                                              </ul>
                                    ...
                                    <div class="text">
                    <div class="title">
                      <a href="#!" title="آيس دريب">آيس دريب</a>
                    </div>
                                          <p>قهوة مفلترة بطريقة v60 محضر بالطريقة الخاصة بموكّافي، استخلاص بارد.<br>
يمكنك اختيار نوع حبوب القهوة.</p>
                                                              <p>الإضافات: <span>انقر للإضافة</span></p>
                      <div class="addetions">
                        <ul>
  ...
  <section class="contact-info">
      <div class="container">
        ...
        <div class="details">
          <div class="item">
            <ul>
              <li>
                <a href="https://api.whatsapp.com/send/?phone=963946592259" target="_blank">
                  <i class="fa-brands fa-whatsapp"></i>
                  <span>963946592259</span>
                </a>
              </li>
              <li>
                <a href="tel:963946592259" target="_blank">
          ...
          <div class="item">
            <ul>
              <li>
                <a href="https://maps.app.goo.gl/8KNmDyCEj3Sfdkc5A" target="_blank">
                  <i class="fa-solid fa-location-dot"></i>
                                    <span>سوريا - ريف دمشق - مدينة التل - السرايا</span>
                </a>
              </li>
            </ul>
          </div>
              ...
              <ul>
                <li>
                    <a>
                      ...
                      <span>من بعد الإفطار مباشرة حتى الساعة 1 ليلاً</span>
                    </a>
                </li>
              </ul>
            </div>
              ...
              <ul>
                                    <li>
                      <a href="https://www.facebook.com/mocafecoffee" target="_blank">
                        <i class="fa-brands fa-facebook-f"></i>
                        <span>Facebook</span>
                      </a>
                    </li>
                                                      <li>
                      <a href="https://www.instagram.com/mocafecoffee" target="_blank">
    ...
    <div class="logo">
        <img src="https://mocafecoffee.com/storage/settings/ed471962.png" alt="MOCAFE' موكّافي">
    </div>
    <div class="text">
       <p>قهوتك اللي راح تدمنها</p>
    </div>
    <div class="copyrighted">
     <div class="container">
      <p>
        ...
        بواسطة
        <a href="https://yummmenu.com/" target="_blank"><strong>يم منيو</strong></a>
      </p>
    ...
    <div class="modal fade open-card" id="open-card" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-items">
                                                    <div class="item">
                                <div class="image">
                                    <img src="https://mocafecoffee.com/storage/products/4a4ef96f.jpg">
                                </div>
                                <div class="details">
                                    <div class="content">
                                        <h3>لافلي داي</h3>
                                        <div class="price">
                                            <span class="quantity">
                                                الكمية 1 <span class="amount">
                                                                                                    السعر  50000 ل.س</span>
                                                                                            </span>
                                                                ...
                                                                <div class="close">
                                    <button class="delete" data-id="829"><i class="fa-solid fa-xmark"></i></button>
                                </div>
                            </div>
                                                <div class="item hide">
                            <div class="image">
    ...
    window.addEventListener('load', function() {
      const activeItem = document.querySelector('.cat-list .active');
      if (activeItem) {
    ...
    <script src="https://cdn.jsdelivr.net/npm/pjax/pjax.min.js"></script>
    <script src="{{ asset('ar/script.js') }}"></script>
